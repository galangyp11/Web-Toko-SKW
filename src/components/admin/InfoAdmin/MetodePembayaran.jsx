                ...
                <p className="text-judul-data-admin">Metode Pembayaran</p>
                    ...
                    <div className="row my-2">
                        <div className="col d-flex justify-content-center">
                            {isTambahMP? <div className="row">
                                <div className="col">
                                    <button className="btn btn-outline-danger" onClick={handleBatalMP} style={{width:"11em"}}>Batal</button>
                                </div>
                                <div className="col">
                                    <button className='but-input-item-penjual' onClick={handleSimpanMP} style={{width:"11em"}}>Simpan</button>
                                </div>
                            </div>
