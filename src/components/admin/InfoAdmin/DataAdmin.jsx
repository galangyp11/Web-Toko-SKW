                ...
                <div className="row">                            
                    <div className="bg-data-info row">
                        ...
                        <div className="col-4">
                            <input 
                                type="text" 
                                id="email" 
                                className="input-text" value={!isEdit ? dataAdmin.email : dataInput.email} 
                                disabled={isDisable} 
                    ...
                    <div className="row my-2">
                        <div className="col d-flex justify-content-center">
                            {!isEdit ?
                            <button className='btn btn-warning' onClick={handleEdit} style={{width:"11em"}}>Edit</button>
                            :
                            <div className="row">
                                <div className="col">
                                <button className="btn btn-outline-danger" onClick={handleBatal} style={{width:"8em"}}>Batal</button>
                                </div>
                                <div className="col">
                                <button className="but-input-item-penjual" onClick={handleSimpan} style={{width:"8em"}}>Simpan</button>
                                </div>
                            </div>
                            }
                        </div>
