        ...
        <div className="footer-keranjang">
           <div className="row px-1 d-flex justify-content-center align-items-start " style={{height:"100%"}}>
                <div className="row d-flex justify-content-center mt-3" >
                    ...
                    <div className="col">
                        <p className="text-total-harga-nominal-keranjang d-flex justify-content-start align-items-center" id='text-footer-keranjang'>{formatUang(totalHarga.harga_item).replace(/\,00/g, '')}</p>
                    </div>
                ...
                <div className="row">
                    ...
                    <div className="row">
                        <div className="col">
                            <p className='text-rincian-isi'>Total item {totalItem.current}</p>
                        </div>
                        <div className="col">
                            <p>{formatUang(totalHarga.harga_item).replace(/\,00/g, '')}</p>
                        </div>
